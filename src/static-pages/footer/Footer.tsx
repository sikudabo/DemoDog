...
export default function Footer() {
    ...
    const shouldShowFooter = useMemo(() => {
        if (pathname.includes('sign-up') || pathname.includes('sign-in') || pathname.includes('startup-dashboard') || pathname.includes('search-companies') || pathname.includes('startup-profile') || pathname.includes('demo-video-profile-page') || pathname.includes('demo-page')) {
            return false;
        }
        return true;
    }, [pathname]);
